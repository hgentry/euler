...
impl PokerHand {
    pub fn from_cards(mut cards: Vec<PokerCard>) -> PokerHand {
        ...
        let mut hand = PokerHand{cards: cards, tier: 0, rank: 0};
        hand.determine_tier();
        return hand;
    }
    ...
    pub fn pair_count(&self) -> PairCountResult {
        ...
        if best_found_count == 4 {
            return PairCountResult{tier:"Four Of A Kind".to_string(), rank: best_found_rank};
        }
        if best_found_count == 3 {
            let mut pair_check = PairCountResult{tier: "".to_string(), rank: 0};
            if self.cards.len() == 5 {
            ...
            if self.cards.len() == 5 && pair_check.tier == "One Pair" {
                return PairCountResult{tier:"Full House".to_string(), rank: best_found_rank};
            } else {
                return PairCountResult{tier:"Three Of A Kind".to_string(), rank: best_found_rank};
            }
        }
        if best_found_count == 2 {
            ...
            if self.cards.len() == 5 && pair_check.tier == "One Pair" {
                return PairCountResult{tier:"Two Pair".to_string(), rank: best_found_rank};
            } else {
                return PairCountResult{tier:"One Pair".to_string(), rank: best_found_rank};
            }
        }

        return PairCountResult{tier:"High Card".to_string(),rank: best_found_rank};
    }
