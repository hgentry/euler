pub fn solve() -> i64 {
    ...
    for i in 1000..10000 {
        ...
        if triangles.contains(&x) {
            ...
            let mut tries = 0;
            loop {
                if !found[0].1 { //still looking for square
                ...
                if !found[1].1 { //still looking for pentagon
                ...
                if !found[2].1 { //still looking for hexagon
                ...
                if !found[3].1 { //still looking for heptagon
                ...
                if !found[4].1 { //still looking for octagon
